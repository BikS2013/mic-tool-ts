...
Status: implemented 2026-05-20, extended for system-wide activation on 2026-05-20, and updated to the `Command+'` default on 2026-05-20. Original refined request: `docs/reference/refined-request-ui-push-to-talk-hotkey.md`. System-wide refinement: `docs/reference/refined-request-system-wide-command-backtick-hotkey.md`. Command-apostrophe refinement: `docs/reference/refined-request-command-apostrophe-hotkey.md`. Investigation: `docs/reference/investigation-system-wide-command-backtick-hotkey.md`. Codebase scans: `docs/reference/codebase-scan-system-wide-command-backtick-hotkey.md` and `docs/reference/codebase-scan-command-apostrophe-hotkey.md`. Implementation plans: `docs/design/plan-010-ui-push-to-talk-hotkey.md`, `docs/design/plan-011-system-wide-command-backtick-hotkey.md`, and `docs/design/plan-012-command-apostrophe-hotkey.md`.

The UI settings surface includes a push-to-talk enable switch and an editable accelerator string. The default accelerator is the explicit UI preference `Command+'`; invalid accelerator text is rejected by shared settings validation instead of being replaced by a hidden fallback. The setting is UI-runtime scoped, matching the current UI settings model. The parser accepts apostrophe aliases such as `Quote` and `Apostrophe`, and the system-wide native hook maps that key to `uiohook-napi`'s `Quote` key code.
